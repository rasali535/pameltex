                ...
                <div className="container">
                    <div style={{ maxWidth: '800px', margin: '0 auto', background: '#fff', padding: '40px', borderRadius: '8px', boxShadow: '0 5px 15px rgba(0,0,0,0.05)' }}>
                        <div style={{ marginBottom: '20px', borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                            <div style={{ fontWeight: '700', color: 'var(--brand-purple)', marginBottom: '10px', fontSize: '18px' }}>Who are the counsellors?</div>
                        ...
                        <div style={{ marginBottom: '20px', borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                            <div style={{ fontWeight: '700', color: 'var(--brand-purple)', marginBottom: '10px', fontSize: '18px' }}>Is it confidential?</div>
                        ...
                        <div style={{ marginBottom: '20px', borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                            <div style={{ fontWeight: '700', color: 'var(--brand-purple)', marginBottom: '10px', fontSize: '18px' }}>How much does it cost?</div>
                        ...
                        <div style={{ marginBottom: '20px', borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                            <div style={{ fontWeight: '700', color: 'var(--brand-purple)', marginBottom: '10px', fontSize: '18px' }}>Can I have online sessions?</div>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            <div style={{ fontWeight: '700', color: 'var(--brand-purple)', marginBottom: '10px', fontSize: '18px' }}>What helps with anxiety?</div>
